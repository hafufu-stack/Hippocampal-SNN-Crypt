...
# ==========================================
# 🧬 Neuron Parameters (v1.2 with CA1)
# ==========================================
NEURON_TYPES = {
    "GC":  {"a": 0.02, "b": 0.2,  "c": -65.0, "d": 8.0}, # DG: Strong filter
    "CA3": {"a": 0.02, "b": 0.2,  "c": -55.0, "d": 4.0}, # CA3: Bursting/Recurrent
    "CA1": {"a": 0.02, "b": 0.2,  "c": -65.0, "d": 6.0}, # CA1: Output/Comparator
}

def generate_network_params(n_neurons, neuron_type="GC"):
    """
    Generate parameters for specific hippocampal populations.
    """
...
def generate_connections(n_pre, n_post, connection_prob, weight_val, random_weight=False):
    """
    Generate sparse connections (CSR format).
    """
    pointers = [0]
    all_indices = []
